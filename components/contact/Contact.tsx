        ...
        <div className="contact-content relative flex min-h-[100svh] w-full flex-col items-center justify-between pt-12">
          ...
          <div className="flex w-full justify-between py-12">
            <div>
              ...
              <Link
                href="https://github.com/ibraiiian"
                target="_blank"
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="flex items-center gap-x-2">
                <ContactLink
                  href="https://instagram.com/ibrabahaly"
                  label="Instagram"
                  icon={
                ...
                />
                <ContactLink
                  href="mailto:ibrabahalybrahim@gmail.com"
                  label="Email"
                  icon={
                ...
                />
                <ContactLink
                  href="http://linkedin.com/in/ibrahim-bahaly-46228b281"
                  label="LinkedIn"
                  icon={
